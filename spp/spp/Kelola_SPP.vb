...
Public Class Kelola_SPP
    ...
    End Sub
    Private Sub cbidspp_TextChanged(sender As Object, e As EventArgs) Handles cbidspp.TextChanged

    End Sub

    Private Sub cbidspp_TextChanged_1(sender As Object, e As EventArgs) Handles cbidspp.TextChanged
